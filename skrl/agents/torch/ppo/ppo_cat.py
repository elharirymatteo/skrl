...
class PPO_CAT(Agent):
    ...
    def init(self, trainer_cfg: Optional[Mapping[str, Any]] = None) -> None:
        ...
        if self.memory is not None:
            ...
            self.memory.create_tensor(name="terminated", size=1, dtype=torch.float32) # CaT: Redefining dones as float32 instead of bool
    ...
    def _update(self, timestep: int, timesteps: int) -> None:
        ...
        def compute_gae(
            ...
            not_dones = 1.0 - dones # CaT: Redefining dones as float32 instead of bool
